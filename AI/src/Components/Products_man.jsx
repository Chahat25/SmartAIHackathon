...
const MenProd = () => {
  ...
  const companies = [
    ...
    {
      name: 'H&M',
      description: 'Men Regular Fit Corduroy shirt',
      imgSrc: 'https://lp2.hm.com/hmgoepprod?set=quality%5B79%5D%2Csource%5B%2F81%2F6b%2F816b54bd465d23ad1ed03c4c43e61dd6e6cecb81.jpg%5D%2Corigin%5Bdam%5D%2Ccategory%5B%5D%2Ctype%5BLOOKBOOK%5D%2Cres%5Bm%5D%2Chmver%5B1%5D&call=url[file:/product/main]',
      price: 1399,
      discount: 30,
      tags: [
        { name: 'branding', color: '#d3b19a' },
     ...
     {
      name: 'H&M',
      description: 'Loose Fit Printed T-shirt',
      imgSrc: 'https://lp2.hm.com/hmgoepprod?set=quality%5B79%5D%2Csource%5B%2F57%2F0e%2F570eb77a6b1362d7c89b653ac6ef7c7d2d5df481.jpg%5D%2Corigin%5Bdam%5D%2Ccategory%5B%5D%2Ctype%5BLOOKBOOK%5D%2Cres%5Bm%5D%2Chmver%5B1%5D&call=url[file:/product/main]',
      price: 599,
      discount:25,
      tags: [
        { name: 'branding', color: '#d3b19a' },
     ...
     {
      name: 'Rare Rabbit',
      description: 'BRANDING PRINT T-SHIRT LALYY - PURPLE',
      imgSrc: 'https://thehouseofrare.com/cdn/shop/files/hero-2_5acd3857-8ce0-4b66-a818-5a356a80cba5.jpg?v=1689679144&_gl=1*x1j8zp*_up*MQ..*_gs*MQ..&gclid=Cj0KCQiAr7C6BhDRARIsAOUKifhQvNsqPoU7lxgZuEM3W16EbDqqQmdd3_4Pfzaq57H5EBFwAaFQ7EMaArz0EALw_wcB',
      price: 1057,
      discount:54,
      tags: [
        { name: 'branding', color: '#d3b19a' },
